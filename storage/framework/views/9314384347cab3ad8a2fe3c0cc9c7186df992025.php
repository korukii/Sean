...
<div class="d-flex">
    ...
    <div class="dropdown d-inline-block user-dropdown">
        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
            ...
            <img class="rounded-circle header-profile-user" src="<?php echo e((!empty($adminData->profile_image))? url('upload/admin_images/'.$adminData->profile_image):url('upload/no_image.jpg')); ?>"
                alt="Header Avatar">
        ...
        <div class="dropdown-menu dropdown-menu-end">
            ...
            </header><?php /**PATH C:\laragon\www\Start Backup\basic\resources\views/admin/body/header.blade.php ENDPATH**/ ?>